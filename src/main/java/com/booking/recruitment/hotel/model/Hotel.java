...
@FilterDef(name = "deletedHotelsFilter", parameters = @ParamDef(name = "isDeleted", type = org.hibernate.type.descriptor.java.BooleanJavaType.class))
@Filter(name = "deletedHotelsFilter", condition = "deleted = :isDeleted")
